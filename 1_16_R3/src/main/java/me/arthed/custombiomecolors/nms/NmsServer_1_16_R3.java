...
public class NmsServer_1_16_R3 implements NmsServer {
    ...
    public NmsBiome getBiomeFromBiomeKey(BiomeKey biomeKey) {
        return new NmsBiome_1_16_R3(this.biomeRegistry.a(ResourceKey.a(
                IRegistry.ay,
    ...
    public NmsBiome getBiomeFromBiomeBase(Object biomeBase) {
        return new NmsBiome_1_16_R3((BiomeBase) biomeBase);
    }
