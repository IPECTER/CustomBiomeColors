...
public class NmsServer_1_17_R1 implements NmsServer {
    ...
    public NmsBiome getBiomeFromBiomeKey(BiomeKey biomeKey) {
        return new NmsBiome_1_17_R1(this.biomeRegistry.a(ResourceKey.a(
                IRegistry.aO,
    ...
    public NmsBiome getBiomeFromBiomeBase(Object biomeBase) {
        return new NmsBiome_1_17_R1((BiomeBase) biomeBase);
    }
