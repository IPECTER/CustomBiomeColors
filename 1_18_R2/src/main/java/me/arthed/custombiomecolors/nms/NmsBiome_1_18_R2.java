...
public class NmsBiome_1_18_R2 implements NmsBiome {

    private final BiomeBase biomeBase;

    public NmsBiome_1_18_R2(BiomeBase biomeBase) {
    ...
    public NmsBiome cloneWithDifferentColors(NmsServer nmsServer, BiomeKey newBiomeKey, BiomeColors newColors) {
        ResourceKey<BiomeBase> customBiomeKey = ResourceKey.a(IRegistry.aP, new MinecraftKey(newBiomeKey.key, newBiomeKey.value));
        BiomeBase.a customBiomeBuilder = new BiomeBase.a();

        customBiomeBuilder.a(this.biomeBase.a());
        ...
        return new NmsBiome_1_18_R2(customBiome);
    }
