...
public class NmsServer_1_18_R2 implements NmsServer {
    ...
    public NmsBiome getBiomeFromBiomeKey(BiomeKey biomeKey) {
        return new NmsBiome_1_18_R2(this.biomeRegistry.a(ResourceKey.a(
                IRegistry.aP,
    ...
    public NmsBiome getBiomeFromBiomeBase(Object biomeBase) {
        return new NmsBiome_1_18_R2((BiomeBase) biomeBase);
    }
