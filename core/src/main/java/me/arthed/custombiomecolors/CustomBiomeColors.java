...
public final class CustomBiomeColors extends JavaPlugin {
    ...
    public void onLoad() {
        ...
        if (Bukkit.getVersion().contains("1.16")) {
            this.nmsServer = new NmsServer_1_16_R3();
        } else if (Bukkit.getVersion().contains("1.17")) {
            this.nmsServer = new NmsServer_1_17_R1();
        } else if (Bukkit.getVersion().contains("1.18")) {
            if (Bukkit.getVersion().contains("1.18.2")) {
                this.nmsServer = new NmsServer_1_18_R2();
            } else {
                this.nmsServer = new NmsServer_1_18_R1();
            }
        } else if (Bukkit.getVersion().contains("1.19")) {
            this.nmsServer = new NmsServer_1_19_R1();
        } else {
